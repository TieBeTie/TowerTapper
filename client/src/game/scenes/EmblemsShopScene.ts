...
export default class EmblemsShopScene extends Phaser.Scene implements IScene {
    ...
    create(): void {
        ...
        // Воспроизводим музыку для магазина эмблем
        this.audioManager.playMusic('emblem_shop');
    ...
    shutdown(): void {
        // Останавливаем музыку магазина при выходе из сцены
        const audioManager = AudioManager.getInstance(this);
        // Возвращаемся к стандартной музыке
